...
Script Purpose:
This script creates a new database named 'DataWarehouse' after checking if it already extist.
If the database exists, it is dropped and recreated. Additionally, the script sets up 
three schemas within the database named bronze, silver and gold
